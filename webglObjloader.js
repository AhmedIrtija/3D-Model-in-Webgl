...
import { MTLLoader } from './webglMtlloader.js'
...
class OBJLoader {
    ...
    load( gl ) {
        ...
        position_data = vertex_positions.concat(vertex_normals);
        ...
        if (material.hasTexture()) {
            ...
            texture_data = vertex_tangents.concat(vertex_texture_coords);
            // TODO: Pass tangents and texture coordinates
        }
        vertex_data = position_data.concat(texture_data);
